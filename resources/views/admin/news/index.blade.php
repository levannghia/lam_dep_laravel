        ...
        <div class="card">
            <form>
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.news.add') }}" class="btn btn-info mb-3"><i class="fa fa-plus"></i>
                        Thêm</a>
                    <div class="row">
                        <div class="col-12">
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a class="dropdown-item" href="/tin-tuc/{{$item->slug}}" target="_blank" style="color: #5646ff"><i
