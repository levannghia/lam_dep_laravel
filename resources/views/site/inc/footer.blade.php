...
foreach ($all_user_online as $key => $value) {
    ...
    if ($time > $time_out) {
        $delete_user_online = DB::table('user_online')
            ->where('id', $value->id)
            ->delete();
    }
}
...
<footer>
    ...
    <div class="container">
        <div class="copy-right">
            <div class="wapper">
                <div class="cop-l">© Copyright 2017 company name, All rights reserved, Design by Sota Group
                </div>
                <div id="lienket">
